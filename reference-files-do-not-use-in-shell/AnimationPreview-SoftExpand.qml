...
Window {
  ...
  title: "Soft Expand — Enter/Space open · Esc close"
  color: "#120f1b"
  ...
  function openIt() { if (box.visible) return; box.visible = true
    ...
    o_s.from = 0.45; o_s.to = 1.0; o_s.duration = 380; o_s.easing.type = Easing.OutCubic
  ...
  function closeIt() { if (!box.visible) return
    ...
    c_s.from = 1.0; c_s.to = 0.55; c_s.duration = 180; c_s.easing.type = Easing.InQuad
